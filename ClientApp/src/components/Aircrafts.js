...
import {
    ...
    Create, EditButton, DeleteButton, Filter, required, SearchInput,TopToolbar, CreateButton
} from 'react-admin';
    ...
    if (data) {
        return (
            <React.Fragment>
                ...
                {/* <Route exact path="/Aircraft/create" component={AcCreate} />, */}
                <Route
                    exact path="/Aircraft/create"
                    render={() => (
                        <AcCreate {...props} />
                    )}
                />
